<template>
    <div>
        ...
        <div>
            <my-buttons @click="$store.commit('incrementLikes')">Лайк</my-buttons>   <!-- Функция commit нужна для работы с мутациями  -->
            <my-buttons @click="$store.commit('decrementLikes')">Дизлайк</my-buttons>
        </div>
